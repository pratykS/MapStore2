...
module.exports = {
    plugins: {
        ...
        ContextManagerPlugin: require("../plugins/contextmanager/ContextManager")
            .default,
        ...
        DashboardSaveAsPlugin: require("../plugins/DashboardSave")
            .DashboardSaveAs,
        GeoStoryNavigationPlugin: require("../plugins/GeoStoryNavigation")
            .default,
        ...
        TimezonePlugin: require("../plugins/timezone"),
    },
    requires: {
